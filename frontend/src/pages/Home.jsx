...
const Home = () => {
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-gray-50 md:flex-row">
      ...
      {/* VÍ BAY (FLOATING WALLET) - Hỗ trợ Touch cho điện thoại */}
      <div
        ref={dragRef}
      ...
      >
        <div className="transform rounded-2xl border border-blue-200 bg-gradient-to-r from-blue-500 to-indigo-500 px-4 py-2 text-center shadow-lg transition-all duration-300 hover:scale-105 md:px-6 md:py-3">
